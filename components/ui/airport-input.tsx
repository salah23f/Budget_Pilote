      ...
      {isOpen && results.length > 0 && (
        <div className="absolute z-50 mt-1 w-full max-h-64 overflow-y-auto rounded-xl shadow-2xl" style={{ background: '#1C1917', border: '1px solid rgba(255,255,255,0.1)' }}>
          {results.map((r, i) => (
            ...
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-lg text-xs font-bold flex-shrink-0" style={{ background: 'color-mix(in srgb, var(--flyeas-accent, #F59E0B) 10%, transparent)', color: 'var(--flyeas-accent, #F59E0B)' }}>
