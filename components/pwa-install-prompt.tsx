    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-pen-1">Install Flyeas</p>
          <p className="text-[11px] text-pen-2 mt-0.5 leading-relaxed">
            {isIos
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <button
              onClick={dismiss}
              className="px-3 py-1.5 rounded-lg text-xs font-medium text-pen-2 hover:text-pen-1/90 transition"
            >
              Not now
            </button>
          </div>
        ...
        <button
          onClick={dismiss}
          aria-label="Close"
          className="text-pen-3 hover:text-pen-2 transition p-1 -m-1"
        >
