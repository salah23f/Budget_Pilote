  ...
  return (
    <div
      ...
      style={{
        ...
        border: '1px solid color-mix(in srgb, var(--flyeas-accent, #F59E0B) 30%, transparent)',
        boxShadow: '0 20px 60px color-mix(in srgb, var(--flyeas-accent, #F59E0B) 15%, transparent)',
          ...
          <div className="flex items-center gap-2 mt-3">
            {!isIos && deferred && (
              <button
                ...
                style={{ background: 'var(--flyeas-gradient, linear-gradient(135deg, #F59E0B, #F97316))', color: 'white' }}
              >
                Install
              </button>
            )}
