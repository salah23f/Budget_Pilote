    ...
    <div className="space-y-6 fade-in">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-ink-800 border border-line-1 rounded-lg p-4 space-y-3">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-ink-800 border border-line-1 rounded-lg p-5 space-y-2">
      ...
      <div className="space-y-3">
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-ink-800 border border-line-1 rounded-lg p-4 flex items-center gap-3">
...
export function FlightsSkeleton() {
  return (
    <div className="space-y-6 fade-in">
      {/* Search form */}
      <div className="bg-ink-800 border border-line-1 rounded-lg p-5 space-y-4">
      ...
      {/* Results */}
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="bg-ink-800 border border-line-1 rounded-lg p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <Skeleton variant="circle" size="md" />
  ...
  return (
    <div className="space-y-6 fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-ink-800 border border-line-1 rounded-lg overflow-hidden">
...
export function BookingsSkeleton() {
  return (
    <div className="space-y-4 fade-in">
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="bg-ink-800 border border-line-1 rounded-lg p-5 space-y-3">
